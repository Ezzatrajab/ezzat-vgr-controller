...
def get_file_paths(enhet_kst, base_path=None):
    ...
    file_map = {
        # Stor-Göteborg Rehab-enheter (använder P&L.xlsx istället för P&L Actual.xlsx)
        '601': {'fte_actual': 'FTE Producerande per Yrkesgrupp (7).xlsx', 'hr_cost': 'HR Cost (12).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (26).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '602': {'fte_actual': 'FTE Producerande per Yrkesgrupp (8).xlsx', 'hr_cost': 'HR Cost (13).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (27).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '603': {'fte_actual': 'FTE Producerande per Yrkesgrupp (19).xlsx', 'hr_cost': 'HR Cost (25).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (28).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '604': {'fte_actual': 'FTE Producerande per Yrkesgrupp (20).xlsx', 'hr_cost': 'HR Cost (26).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (29).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '605': {'fte_actual': 'FTE Producerande per Yrkesgrupp (21).xlsx', 'hr_cost': 'HR Cost (27).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (30).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '607': {'fte_actual': 'FTE Producerande per Yrkesgrupp (22).xlsx', 'hr_cost': 'HR Cost (28).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (31).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '660': {'fte_actual': 'FTE Producerande per Yrkesgrupp (23).xlsx', 'hr_cost': 'HR Cost (29).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (33).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '715': {'fte_actual': 'FTE Producerande per Yrkesgrupp (24).xlsx', 'hr_cost': 'HR Cost (30).xlsx', 'intakt_budget': 'Intäkt Budget Rehab (34).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},

        # Stor-Göteborg VC-enheter (använder P&L.xlsx istället för P&L Actual.xlsx)
        '102': {'fte_actual': 'FTE Producerande per Yrkesgrupp (4).xlsx', 'hr_cost': 'HR Cost (10).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '103': {'fte_actual': 'FTE Producerande per Yrkesgrupp (5).xlsx', 'hr_cost': 'HR Cost (11).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '104': {'fte_actual': 'FTE Producerande per Yrkesgrupp (9).xlsx', 'hr_cost': 'HR Cost (14).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '106': {'fte_actual': 'FTE Producerande per Yrkesgrupp (10).xlsx', 'hr_cost': 'HR Cost (15).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '107': {'fte_actual': 'FTE Producerande per Yrkesgrupp (11).xlsx', 'hr_cost': 'HR Cost (16).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '108-109': {'fte_actual': 'FTE Producerande per Yrkesgrupp (12).xlsx', 'hr_cost': 'HR Cost (17).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '110': {'fte_actual': 'FTE Producerande per Yrkesgrupp (13).xlsx', 'hr_cost': 'HR Cost (19).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '111': {'fte_actual': 'FTE Producerande per Yrkesgrupp (14).xlsx', 'hr_cost': 'HR Cost (20).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '302-303': {'fte_actual': 'FTE Producerande per Yrkesgrupp (15).xlsx', 'hr_cost': 'HR Cost (21).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '304': {'fte_actual': 'FTE Producerande per Yrkesgrupp (16).xlsx', 'hr_cost': 'HR Cost (22).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '015': {'fte_actual': 'FTE Producerande per Yrkesgrupp (17).xlsx', 'hr_cost': 'HR Cost (23).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
        '4020': {'fte_actual': 'FTE Producerande per Yrkesgrupp (18).xlsx', 'hr_cost': 'HR Cost (24).xlsx', 'pl_actual': 'P&L.xlsx', 'pl_budget': 'P&L Budget.xlsx'},
...
def load_all_data_for_enhet(enhet_kst, manad_str, base_path=None):
    ...
    # UPPDATERAD 2026-05-05: Rehab Poäng hämtas nu från Poänguppföljning Rehab 2026.xlsx
    # via info_loader.py (rad 694-702), så ingen OVERRIDE behövs längre.
    # Data läses från Dashboard-fliken enligt Inställningar.xlsx
